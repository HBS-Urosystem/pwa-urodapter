<script lang="ts">
	...
	const cards = [
		{ title: 'Educational Video', href: '/how-the-urodapter-works', icon: 'tool' },
		{
			...
			href: '/what-to-do-prior-to-instillation',
			icon: 'gear'
		},
		{
...
{#snippet cardIcon(icon: string)}
	...
	{:else if icon === 'male'}
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
			><path
				d="M24.28,18.52c2.08-2.05,3.22-4.77,3.22-7.67s-1.14-5.62-3.22-7.67c-4.29-4.24-11.27-4.24-15.55,0-2.08,2.05-3.22,4.77-3.22,7.67s1.14,5.62,3.22,7.67c2,1.98,4.59,3.02,7.22,3.15v4.76h-4.99c-.31,0-.56.25-.56.55s.25.55.56.55h4.99v4.92c0,.31.25.55.56.55s.56-.25.56-.55v-4.92h4.99c.31,0,.56-.25.56-.55s-.25-.55-.56-.55h-4.99v-4.76c2.62-.13,5.22-1.17,7.22-3.15h0ZM6.62,10.84c0-2.6,1.03-5.05,2.89-6.89,1.92-1.9,4.46-2.85,6.99-2.85s5.06.95,6.99,2.85c1.87,1.84,2.89,4.29,2.89,6.89s-1.03,5.05-2.89,6.89c-3.85,3.8-10.12,3.8-13.97,0-1.87-1.84-2.89-4.29-2.89-6.89Z"
			/></svg
		>
	{:else if icon === 'help'}
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
			><path
				d="M16.5,4c-6.89,0-12.5,5.61-12.5,12.5s5.61,12.5,12.5,12.5,12.5-5.61,12.5-12.5-5.6-12.5-12.5-12.5ZM16.5,27.75c-6.21,0-11.25-5.05-11.25-11.25s5.05-11.25,11.25-11.25,11.25,5.05,11.25,11.25-5.05,11.25-11.25,11.25h0ZM18.6,10.43c-.84-.54-1.97-.71-3.02-.47-1.05.25-1.93.9-2.47,1.82-.14.24-.06.55.18.69.24.14.55.06.69-.18.52-.88,1.29-1.22,1.83-1.35.78-.18,1.64-.06,2.24.33.6.38.98.99,1.07,1.68.08.65-.12,1.29-.59,1.79-2.14,2.32-3,3.63-2.74,5.66.03.25.25.44.5.44h.06c.28-.03.47-.29.44-.56-.21-1.62.44-2.64,2.48-4.85.67-.73.97-1.65.85-2.6-.12-.98-.68-1.85-1.53-2.4h0ZM16.35,21.91c-.47,0-.86.38-.86.86s.38.85.86.85.86-.38.86-.85-.38-.86-.86-.86Z"
			/></svg
		>
...
{#if showIntro}
	...
	>
		...
		<video
			...
			loop
			playsinline
			class="mt-12 mb-4 h-48 w-48 object-contain mix-blend-screen"
		></video>
		...
		<svg
			...
			><radialGradient
				...
				cx="160"
				cy="32"
				gradientTransform="matrix(1 0 0 .15 0 20.7)"
				gradientUnits="userSpaceOnUse"
				r="160"
				><stop offset="0" stop-color="#22303a" stop-opacity=".1" /><stop
					offset="1"
					stop-color="#22303a"
					stop-opacity="0"
				/></radialGradient
			><rect fill="url(#a)" height="100%" width="100%" /></svg
		>
		<!-- <img src="/assets/img/intro-img-shadow.svg" alt="" class="w-48 -mt-8" /> -->

		<p class="mt-4 max-w-md px-4 text-center text-white">
	...
	<div class="container mx-auto">
		...
		<div class="mt-8 mb-4 text-center">
			...
			{#if downloading && progress < 100}
				<div class="mt-4 flex justify-center">
					<progress class="progress w-64 progress-primary" value={progress} max="100"></progress>
				</div>
			{/if}
		</div>
		...
		<div class="mt-4 flex flex-wrap items-center justify-center gap-2">
			<a href={resolve('/install')} class="btn btn-ghost btn-sm">
				<svg xmlns="http://www.w3.org/2000/svg" class="mt-1 h-6 w-6" viewBox="0 0 40 40">
					<path
						d="M16.5 3v18m0 0l-6-6m6 6l6-6M5 24v3h23v-3"
						fill="none"
						stroke="currentColor"
